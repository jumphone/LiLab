...
DIFF_TCMTEM_TCMdivTEM = DIFF_TCMTEM_RPM_TCM / (DIFF_TCMTEM_RPM_TEM+delta)
DIFF_TCMTEM_TEMdivTCM = DIFF_TCMTEM_RPM_TEM / (DIFF_TCMTEM_RPM_TCM+delta)


DIFF_CD73_FPKM_POS=apply(DIFF_CD73[,2:4],1,mean)
DIFF_CD73_FPKM_NEG=apply(DIFF_CD73[,5:7],1,mean)

DIFF_CD73_POSdivNEG= DIFF_CD73_FPKM_POS / (DIFF_CD73_FPKM_NEG+delta)
DIFF_CD73_NEGdivPOS= DIFF_CD73_FPKM_NEG / (DIFF_CD73_FPKM_POS+delta)
