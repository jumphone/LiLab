...
DIFF_TCMTEM_RPM_TCM[which(is.na(DIFF_TCMTEM_RPM_TCM))]=0
DIFF_TCMTEM_RPM_TEM[which(is.na(DIFF_TCMTEM_RPM_TEM))]=0


DIFF_TCMTEM_TCMdivTEM = (DIFF_TCMTEM_RPM_TCM+delta) / (DIFF_TCMTEM_RPM_TEM+delta)
DIFF_TCMTEM_TEMdivTCM = (DIFF_TCMTEM_RPM_TEM+delta) / (DIFF_TCMTEM_RPM_TCM+delta)


DIFF_CD73_FPKM_POS=apply(DIFF_CD73[,2:4],1,mean)
DIFF_CD73_FPKM_NEG=apply(DIFF_CD73[,5:7],1,mean)
DIFF_CD73_FPKM_POS[which(is.na(DIFF_CD73_FPKM_POS))]=0
DIFF_CD73_FPKM_NEG[which(is.na(DIFF_CD73_FPKM_NEG))]=0


DIFF_CD73_POSdivNEG= (DIFF_CD73_FPKM_POS+delta) / (DIFF_CD73_FPKM_NEG+delta)
DIFF_CD73_NEGdivPOS= (DIFF_CD73_FPKM_NEG+delta) / (DIFF_CD73_FPKM_POS+delta)
