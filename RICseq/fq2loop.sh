...
BLACK=/seq/ATAC-seq/Data/hg19_kundaje_blacklist.bed
########
##############################################################
# Staring
mkdir $OUT
...
samtools index $OUT\/read1.sorted.rmdup.bam
samtools index $OUT\/read2.sorted.rmdup.bam
bedtools intersect -v -abam $OUT\/read1.sorted.rmdup.bam -b $BLACK > $OUT\/read1.sorted.rmdup.rmblack.bam
bedtools intersect -v -abam $OUT\/read2.sorted.rmdup.bam -b $BLACK > $OUT\/read2.sorted.rmdup.rmblack.bam
samtools merge $OUT\/merged.bam $OUT\/read1.sorted.rmdup.rmblack.bam $OUT\/read2.sorted.rmdup.rmblack.bam
